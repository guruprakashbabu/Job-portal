            ...
            <div class="col-md-12">
                ...
                <%
                    try {
                        ...
                        while (rs.next()) {
                %>
                <div class="card mt-2 job-card"> <!-- Added class job-card for margin -->
                    <div class="card-body">
                        <div class="text-center text-primary">
                            <i class="far fa-clipboard fa-2x"></i>
                        </div>
                        <h6>Title: <%= rs.getString("tittle") %></h6>
                        <h6>Jod Id: <%= rs.getString("id") %></h6>
                        ...
                        <div class="form-row">
                            ...
                            <h6>Publish Date: <%= rs.getString("pdate") %></h6>
                            <div class="text-center">
                                <a href="edit.jsp?n1=<%=rs.getString("id") %>" class="btn btn-sm bg-success text-white">Edit</a> 
                                <a href="delete.jsp?n1=<%=rs.getString("id") %>" class="btn btn-sm bg-danger text-white">Delete</a>
                            </div>
                        </div>
                    </div>
                </div>
